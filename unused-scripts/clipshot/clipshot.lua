...
mp.add_key_binding('Ctrl+d',     'clipshot-subs',   clipshot('subtitles'))
mp.add_key_binding('Ctrl+Shift+d',     'clipshot-video',  clipshot('video'))
mp.add_key_binding('Ctrl+Alt+d', 'clipshot-window', clipshot('window'))
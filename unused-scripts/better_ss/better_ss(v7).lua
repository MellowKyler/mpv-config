...
local function directory_exists(directory)
    --not worth it. i would either have to continually pass through an exit variable to stop it from running
    --or do some goofy ::exit:: nonsense that would likely end the mpv process itself :/

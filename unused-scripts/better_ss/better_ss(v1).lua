...
local function count_check()
    ...
    if (temp_title == 'Anime') or (temp_title == 'qBittorrent') or (temp_title == 'kyler') or (temp_title == 'home') or (search_str == '.etc') or (search_str == '.delay') or (search_str == '.short') then
        uncategorized = true
        return "uncategorized"
    end
    return temp_title
